    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('urgency_status', models.CharField(choices=[('normal', 'Звичайне'), ('urgent', 'Терміново'), ('critical_urgent', 'Критично терміново'), ('overdue', 'Просрочене')], default='normal', max_length=20)),
                ('work_status', models.CharField(choices=[('on_inspection', 'На перевірці'), ('completed', 'Виконано'), ('in_process', 'В процесі'), ('postponed', 'Відкладено')], default='in_process', max_length=20)),
